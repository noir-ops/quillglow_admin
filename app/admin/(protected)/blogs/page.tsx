...
import { ADMIN_LIST_CAP } from "@/lib/admin-pagination"
...
export default async function BlogsPage({
  ...
  let query = supabase
    ...
    // Bounded so a large table can't freeze the page. Use search/filters to
    // narrow rather than scrolling past this cap.
