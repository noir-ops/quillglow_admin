...
import { SyllabusAdoption } from "@/components/syllabus-adoption"
      ...
      <div className="mx-auto max-w-5xl space-y-6">
        ...
        <Card>
          <CardContent className="space-y-2 p-4 text-xs text-muted-foreground">
            ...
            <p>
              A syllabus becomes selectable by learners as soon as it has concepts imported — the picker in their
              settings reads the same data as this page, so there&apos;s no separate publish step.
            </p>
            <p>
